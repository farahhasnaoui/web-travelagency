...
if (isset($_POST['search2'])) 
{
  ...
  $listecircuits=$circuit1C->affichercircuits();  
  $result=$circuit1C->recuperercircuit($_POST['idCircuit']);
...
<script src="/voting_mp/voting.js"></script>
        <!-- REQUIRED META TAGS -->
        <meta charset="utf-8">
                ...
                <div class="row">
                        ...
                        <?PHP foreach($result as $row){?>
                            <div class="col-lg-6">
                                <div class="single-tours-item">
                                    ...
                                    <ul class="single-tours-content">
                                        <li>
                                        Lieu depart: 
                                            <span><?PHP echo $row['lieu_d']; ?></span>
                                        </li>

                                        <li>
                                        Lieu arrivee:   
                                            <span><?PHP echo $row['lieu_a']; ?></span>
                                        </li>

                                        <li>
                                        Nom Circuit: 
                                            <span> <?PHP echo $row['nom_circuit']; ?></span>
                                        </li>
                            ...
                            <div class="col-lg-6">
                                <div class="single-details">
                                    ...
                                    <div class="vot_mp2" data-vote_id="idCircuit"></div>
                                </div>
                            </div>
                            <?php
                            }
                    ...
                    <div class="col-lg-4">
                        <div class="tours-sidebar">
                            ...
                            <form name="f1" method="post" action="front.php">
