...
$voyage1=new voyage($_POST['idVo'],$_POST['airline'],$_POST['lieu_aller'],$_POST['lieu_retour'],$_POST['description'],$_POST['nom_hotel'],$_POST['prix'],$_POST['date_aller'],$_POST['date_retour'],$_POST['image'],$_POST['voy_places']);  
echo"111";
